...
const ACService = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "AC unit gas charging and leak repairs"
    },
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  const locations = [
    {
      name: "AC Repair Service Centre in Annanagar",
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      name: "AC Repair Service Centre in Adambakkam",
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
    ...
    {
      name: "AC Repair Service Centre in Egmore",
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
    ...
    {
      name: "AC Repair Service Centre in Royapettah",
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
    ...
    {
      name: "AC Repair Service Centre in Mylapore",
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="relative pt-16 md:pt-20 lg:pt-24 pb-10 md:pb-16">
          <div className="absolute inset-0 bg-[url('public/lovable-uploads/b1e8912e-4683-445f-acc1-8b465d37146d.png')] bg-cover bg-center opacity-20"></div>
          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 z-10">
            <div className="flex flex-col items-center text-center mb-8">
              <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
                ...
                <span>&gt;</span>
                <span>Air Conditioner Service</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold">
                Air Conditioner <span className="text-purple">Service</span>
              </h1>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div className="service-card">
                ...
                <h2 className="text-3xl font-bold mb-4">
                  <span className="text-purple">AC Repair & Service</span><br /> 
                  center
                </h2>
                <p className="text-gray-600 mb-6">
                  Are you having issues with your air conditioner? Whether it's a minor repair or a major replacement, our team of skilled technicians offers reliable and affordable solutions for all your air conditioning needs. We provide comprehensive installation, maintenance, and servicing for both residential and commercial spaces.
                </p>
              ...
              <div className="flex justify-center">
                <img 
                  src="/lovable-uploads/7fefd053-d1d0-4597-9822-00a9f1734067.png" 
        ...
        <ServicesGrid 
          ...
          subtitle="OUR AC SERVICES INCLUDE"
          highlight="Air Conditioning"
          description="At EasyFix, we offer a full range of professional AC services to keep your home comfortable throughout the year. From installation and repairs to routine maintenance, our expert technicians are equipped to handle all your air conditioning needs. No matter the brand or model, we deliver fast, reliable, and affordable service."
          services={services}
        />
        
        <LocationsSection 
          title="AC Repair Services Across"
